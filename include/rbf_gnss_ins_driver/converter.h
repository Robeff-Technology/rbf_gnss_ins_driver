...
namespace rbf_gnss_ins_driver
{
    ...
    public:
        ...
        sensor_msgs::msg::Temperature raw_imu_to_temperature_msg(const RawImux &raw_imux, std::string frame_id);

        // Function to convert ECEF to twist message
        geometry_msgs::msg::TwistWithCovarianceStamped ecef_to_twist_msg(const ECEF &ecef, const RawImux &raw_imux, std::string frame_id);
