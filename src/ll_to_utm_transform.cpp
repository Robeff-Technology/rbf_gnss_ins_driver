...
void LlToUtmTransform::transform(double lat, double lon, double altitude,
...
void LlToUtmTransform::LLtoUTM(double Lat, double Long, int zoneNumber,
                               double &UTMNorthing, double &UTMEasting) const {
